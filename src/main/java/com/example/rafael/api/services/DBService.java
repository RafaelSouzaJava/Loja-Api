...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Categoria cat6 = new Categoria(null, "HD e SSD");
		Categoria cat7 = new Categoria(null, "Processador");
		Categoria cat8 = new Categoria(null, "Memoria");
		Categoria cat9 = new Categoria(null, "Gabinet");
		Categoria cat10 = new Categoria(null, "Redes");		
		...
		Produto p5 = new Produto(null, "HD Barracuda 1Tb", 800.00);
		Produto p6 = new Produto(null, "Black Desert Ouro", 120.00);
		Produto p7 = new Produto(null, "Teclado Mecanico Razer", 800.00);
		Produto p8 = new Produto(null, "Intel i7 10900k", 1800.00);
		Produto p9 = new Produto(null, "Memoria 16GB", 500.00);
		Produto p10 = new Produto(null, "Gabinete Thermaltak core P7", 1400.00);
		Produto p11 = new Produto(null, "Splint 1/8", 120.00);
		Produto p12 = new Produto(null, "Ryzem 5 5600G", 1300.00);
		
		//PRODUTO ADICIONADOS QUE SERA RETIRADO DEPOIS 		
		...
		cat1.getProdutos().addAll(Arrays.asList(p1, p2, p3, p7, p5, p9, p10, p8, p12, 
				/*PRODUTO QUE SERA RETIRADO DEPOIS8 >>*/  p13, p14, p15, p16, p17, p18, p19, p20, 
		...
		cat7.getProdutos().addAll(Arrays.asList(p8, p12));
		cat8.getProdutos().addAll(Arrays.asList(p9));
		cat9.getProdutos().addAll(Arrays.asList(p10));
		cat10.getProdutos().addAll(Arrays.asList(p11));

		p1.getCategorias().addAll(Arrays.asList(cat1));
		p2.getCategorias().addAll(Arrays.asList(cat1, cat2));
		p3.getCategorias().addAll(Arrays.asList(cat1));
		p4.getCategorias().addAll(Arrays.asList(cat3));
		p5.getCategorias().addAll(Arrays.asList(cat6, cat1));
		p6.getCategorias().addAll(Arrays.asList(cat4));
		p7.getCategorias().addAll(Arrays.asList(cat5, cat1));
		p8.getCategorias().addAll(Arrays.asList(cat7, cat1));
		p9.getCategorias().addAll(Arrays.asList(cat8, cat1));
		p10.getCategorias().addAll(Arrays.asList(cat9, cat1));
		p11.getCategorias().addAll(Arrays.asList(cat10));
		p12.getCategorias().addAll(Arrays.asList(cat7, cat1));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rafael_avalon@hotmail.com", "16403890085", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Rafael de Souza alves", "rafael-souza4@outlook.com", "06377712065", TipoCliente.PESSOAFISICA, pe.encode("#Alucard&Yukys2?"));
		cli2.getTelefones().addAll(Arrays.asList("(85) 988106200)", "93838393"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 808", "Centro", "38777012", cli1, c2);
		
		Endereco e3 = new Endereco(null, "Rua Dr. Manoel Moreira", "359", "Casa C Altos", "Maraponga", "60762480", cli2, c4);
